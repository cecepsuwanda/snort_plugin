...
# rm -rf output/7week_friday_coba.csv
# ./my_rtdtsvm /mnt/d/Thesis_Pasca_Unla/Dataset/mit_darpa_98/seventh_week/friday/coba.pcap output/7week_friday_coba.csv model/model1
# wait
