...
ostream & operator << (ostream &out, const Tconf_metrix &tc)
{
	...
	if (tc.matrik1.size() > 0) {
		...
		out << setw(30) << "kelas" << setw(6) << "TP" << setw(6) << "FN" << setw(6) << "jml" << setw(6) << "FP" << setw(6) << "TN" << setw(10) << "accuracy" << setw(10) << "recall" << setw(13) << "specificity" << endl;  
		for (auto it = tc.matrik1.begin(); it != tc.matrik1.end(); ++it)
		{			
			out << setw(30) << it->first;
			out << setw(6) << it->second.TP;
			out << setw(6) << it->second.FN;
			out << setw(6) << it->second.jml;
			out << setw(6) << it->second.FP;
			out << setw(6) << it->second.TN;
