...
# ./my_dtsvm 1 1 0 0 100 2 0.0001 0.01 data/kddcupSVM_33attr.names data/NSLSVM_33attr_train.txt model model1  0 1 | tee -a ~/Dataset/NSL/model_100_2_svm/hasil.txt
# wait
