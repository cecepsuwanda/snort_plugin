...
# ./my_dtsvm 0 1 1 0 4 2 0.0001 0.01  data/kddcupSVM_33attr.names data/NSLSVM_33attr_train.txt model model1 
# wait
# 
./my_dtsvm 1 1 1 0 4 2 0.0001 0.01 data/kddcupSVM_33attr.names data/NSLSVM_33attr_test.txt model model1
wait 
