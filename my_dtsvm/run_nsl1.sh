...
./my_dtsvm 0 1 0 0 100 2 0.0001 0.01  data/kddcupSVM.names data/NSLSVM_train.txt model model1 0 0 #| tee ~/Dataset/NSL/model_100_2_svm_org/hasil.txt
wait

./my_dtsvm 1 1 0 0 100 2 0.0001 0.01 data/kddcupSVM.names data/NSLSVM_train.txt model model1  0 0 #| tee -a ~/Dataset/NSL/model_100_2_svm_org/hasil.txt
wait
