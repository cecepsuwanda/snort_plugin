...
PATH_MODEL='model_100_2_svm_42attr_credal05_100'
NAMES='data/kddcup.names'
TRAIN='data/NSLTree_train.txt'
TEST='data/NSLTree_test.txt'
TEST1='data/NSLTree_test1.txt'
UNKNOWN='data/NSLTree_unknown.txt'
