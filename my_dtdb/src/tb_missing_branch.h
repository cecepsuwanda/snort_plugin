...
public:
    ...
    void insert_not_split(posisi_cabang posisi,string label);
    void insert_same_label(posisi_cabang posisi,string label);
    void insert_cut_off(posisi_cabang posisi,string label, int is_pure, int is_min_sample, int is_depth_limit);
    void insert_pruning(posisi_cabang posisi,string label);
