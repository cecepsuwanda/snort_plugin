...
private:
	...
	tree_node* build_missing_branch(int counter, Tposisi_cabang posisi, tb_missing_branch &missing_branch);
	...
	tree_node* vec_tree_to_dec_tree(int node_index, int counter, Tposisi_cabang posisi, tb_missing_branch &missing_branch);
